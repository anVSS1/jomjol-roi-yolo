...
Experimental results show strong component-level performance, with 100\% ROI detection success and 99.00\% digit classification accuracy. However, end-to-end performance remains limited by segmentation errors under difficult lighting conditions. Future work should focus on replacing the deterministic projection-based segmentation step with a sequence modeling approach such as CTC-based OCR or an end-to-end recognition network. This would likely improve full-reading accuracy and reduce sensitivity to glare and under-segmentation.
